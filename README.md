...
The project utilizes multiple mutual fund datasets representing fund performance, investor activity, portfolio allocation, and market benchmarks.

| Dataset                      | Description                                                                                              |
| ---------------------------- | -------------------------------------------------------------------------------------------------------- |
| 01_fund_master.csv           | Master information about mutual fund schemes, categories, fund houses, managers, and investment details. |
| 02_nav_history.csv           | Historical Net Asset Value (NAV) records used for return and trend analysis.                             |
| 03_aum_by_fund_house.csv     | Assets Under Management (AUM) data across fund houses.                                                   |
| 04_monthly_sip_inflows.csv   | Monthly SIP contribution trends across the mutual fund industry.                                         |
| 05_category_inflows.csv      | Category-wise investment inflows and outflows.                                                           |
| 06_industry_folio_count.csv  | Industry folio count data used to analyze investor participation.                                        |
| 07_scheme_performance.csv    | Fund performance metrics including returns, alpha, beta, Sharpe ratio, and expense ratio.                |
| 08_investor_transactions.csv | Investor transaction history and investment behavior data.                                               |
| 09_portfolio_holdings.csv    | Portfolio allocation and sector exposure details.                                                        |
| 10_benchmark_indices.csv     | Benchmark market index performance data used for comparison analysis.                                    |
...
The project includes a master execution script that automates the complete ETL workflow.
...
The SQLite database generated by the pipeline:
